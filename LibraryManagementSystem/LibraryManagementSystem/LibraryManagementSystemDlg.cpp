...
// LibraryManagementSystemDlg.cpp: 实现文件
//
...
// CLibraryManagementSystemDlg 对话框



CLibraryManagementSystemDlg::CLibraryManagementSystemDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_LIBRARYMANAGEMENTSYSTEM_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CLibraryManagementSystemDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
// CLibraryManagementSystemDlg 消息处理程序
