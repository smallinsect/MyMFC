...
BEGIN_MESSAGE_MAP(CDemoMFC04Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CDemoMFC04Dlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CDemoMFC04Dlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
//非模态对话框按钮的点击事件
void CDemoMFC04Dlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
	//弹出非模态对话框
	//dlgs.Create(IDD_SHOW);//只能创建一次
	dlgs.ShowWindow(SW_SHOWNORMAL);
}
